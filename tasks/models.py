...
class PriorityCounter(models.Model):
    ...
    def __str__(self):
        return f'Counter of {self.priority} - {self.counter}'
...
class TodoItem(models.Model):
    ...
    priority_counter = models.ForeignKey(
        PriorityCounter, on_delete=models.CASCADE, related_name='prior_counter', null=True, blank=True
    )
